...
my.leaflet <- reactive({
  ...
  leaflet(options = leafletOptions(worldCopyJump = TRUE)) %>%
    ...
    addLayersControl(
      baseGroups = c("World", "Terrain", "Open Street Map", "Ocean Basemap"),
...
renderUI({
  ...
  check3 <- paste("Number of unique APIs: ", nrow(APIs))
