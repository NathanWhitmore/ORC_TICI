...
3. **Data extract tab:** a simplified version of the data within the selected area is shown here. By click on the arrows at the top of each column you can sort the data set by the specific variable.
